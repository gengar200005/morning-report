...
<추세 판단 규칙>
us_data.txt의 지수·섹터 ETF에는 MA20·MA60 데이터가 포함된다 (예: MA20✓위 / MA60✗아래).
kr_data.txt의 종목에는 MA20·MA60·MA120이 포함된다.
MA 데이터가 있으면 반드시 추세 판단을 수행하고 결과를 표기할 것:
  - MA20 위 + MA60 위: "단기·중기 상승추세"
  - MA20 위 + MA60 아래: "단기 반등, 중기 추세 미확인"
  - MA20 아래 + MA60 위: "단기 조정, 중기 추세 유지"
  - MA20 아래 + MA60 아래: "단기·중기 하락추세"
"추세 판단 불가" 표현은 MA 데이터가 없는 항목에만 사용. MA 데이터가 있으면 추세 판단 생략 금지.
